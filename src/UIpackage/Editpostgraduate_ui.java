 ...
 * @author User
 */
public class Editpostgraduate_ui extends javax.swing.JFrame {

    /**
     * Creates new form Undergraduate_UI
     */
    public Editpostgraduate_ui() {
        initComponents();
    ...
    public void  setext(String std_id4, String fname4, String lname4, String addr4, String gen4, String nic4, String email4, String cnum4, String type1, String institute1, String year1){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String[] check = {stdId1,fname1,lname1,addr2,email1,gender,nic1,cnum1,type1,institute1,year1};

        Checktext page = new Checktext(check);

        if (page.fill()){

            Postgraduate student1 = new Postgraduate(Integer.parseInt(stdId1),fname1,lname1,addr2,gender,nic1,email1,Integer.parseInt(cnum1),type1,institute1,year1);
            student1.update();
